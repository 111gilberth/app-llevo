...
public class TinyDB {
    ...
    public ArrayList<ProductModel> getListProductsInCache(String key, Class<?> mClass){
   	Gson gson = new Gson();

   	ArrayList<String> objStrings = getListString(key);
   	ArrayList<ProductModel> objects =  new ArrayList<ProductModel>();

    	for(String jObjString : objStrings){
            ProductModel value  = (ProductModel) gson.fromJson(jObjString,  mClass);
    		objects.add(value);
    	}
    	return objects;
    }
    ...
    public void putListProducts(String key, ArrayList<ProductModel> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
